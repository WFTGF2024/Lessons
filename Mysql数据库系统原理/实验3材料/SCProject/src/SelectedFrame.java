...
public class SelectedFrame extends JFrame{
	...
	public SelectedFrame() {
		setTitle("已选课程查询");
		String s = "SELECT cname as 课程名, Grade as 成绩, Semester as 开课学期, Teachingclass as 上课班级 FROM  SC,Course where sno = "+StudentMainFrame.id +" and SC.cno=Course.cno";
		...
		String[] items = {"课程名","成绩","开课学期","上课班级"};
		String[] cols = {"cname","grade","Semester","Teachingclass"};
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String s = "SELECT cname, grade, semester, teachingclass FROM  SC,course where "+cols[cbb.getSelectedIndex()] +" like '%"+tfName.getText()+"%' and SC.cno=course.cno and sno = "+ StudentMainFrame.id;
				DefaultTableModel model  = getTabelModel(s);
